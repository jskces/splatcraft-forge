...
public class SplatcraftPacketHandler
{
    ...
    public static void registerMessages()
    {
        ...
        registerMessage(UpdateWorldBlockColorsPacket.class, UpdateWorldBlockColorsPacket::decode);
        registerMessage(UpdateChunkBlockColorsPacket.class, UpdateChunkBlockColorsPacket::decode);
    }
